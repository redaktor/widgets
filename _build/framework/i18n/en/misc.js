(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "../../lexicon/tagset"], factory);
    }
    ...
    exports.nGrams = {
        afterWord: {
            ...
            this: tagset_1.NN, his: tagset_1.NN, when: tagset_1.NN, you: tagset_1.VB, very: tagset_1.ADJ, old: tagset_1.NN, never: tagset_1.VB, before: tagset_1.NN // to: VB,
        },
        beforeWord: {
        ...
        beforePOS: {
            ...
            PerfectTense: tagset_1.VB // LastName: 'FirstName'
        }
    };
    // Questions - unterminated / informal
    var blabla = '(#Conjunction|#Preposition|#Adverb)?';
    var allQW = function (qw) {
