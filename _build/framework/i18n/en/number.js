(function (factory) {
    ...
    var numbers = {
        ...
        findModifiers: function (s) {
            var mults = [[/^(minus|negative)[\s\-]/i, -1], [/^(a\s)?half[\s\-](of\s)?/i, 0.5]];
    ...
    for (var k in numbers.ordinal) {
        var ord = Object.keys(numbers.ordinal[k]);
        var card = Object.keys(numbers.cardinal[k]);
    ...
    numbers.tensMapping = Object.keys(numbers.cardinal.tens).map(function (k, i) { return [k, (i + 2) * 10]; }).reverse();
