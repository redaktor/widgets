(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "./tagset"], factory);
    }
    ...
    exports.suffixes = [
        ...
        { fully: tagset_1.ADV, where: tagset_1.ADV, wards: tagset_1.ADV, urned: tagset_1.PA, tized: tagset_1.PA, eased: tagset_1.PA, ances: tagset_1.PL,
            ...
            tieth: 'Ordinal', ishes: tagset_1.PR, tches: tagset_1.PR, /*norway, polish male:*/ nssen: tagset_1.LN, marek: tagset_1.LN },
        // 6-letter
        { keeper: tagset_1.AC, logist: tagset_1.AC, /* lithuania: */ auskas: tagset_1.LN, teenth: 'Value' },
        // 7-letter
        { /* swedish female, greek: */ sdottir: tagset_1.LN, opoulos: tagset_1.LN }
    ];
    // regexes indexed by mandated last-character
    exports.suffixPOS = {
        a: [[/.[aeiou]na$/, tagset_1.NN], [/.[oau][wvl]ska$/, tagset_1.LN /*polish (female)*/], [/.[^aeiou]ica$/, tagset_1.SI],
            [/^([hyj]a)+$/, tagset_1.EXP /*hahah*/]],
        c: [[/.[^aeiou]ic$/, tagset_1.ADJ]],
        d: [[/.[ia]sed$/, tagset_1.ADJ], [/.[gt]led$/, tagset_1.ADJ], [/.[aeiou][td]ed$/, tagset_1.PA], [/[^aeiou]ard$/, tagset_1.SI],
            [/[aeiou][^aeiou]id$/, tagset_1.ADJ], [/[aeiou]c?ked$/, tagset_1.PA /*hooked*/], [/.[vrl]id$/, tagset_1.ADJ]],
        ...
        h: [[/.[^aeiouf]ish$/, tagset_1.ADJ], [/.v[iy]ch$/, tagset_1.LN /*east-europe*/], [/^ug?h+$/, tagset_1.EXP /*uhh*/],
            [/^uh[ -]?oh$/, tagset_1.EXP /*uhoh*/]],
        i: [[/.[oau][wvl]ski$/, tagset_1.LN /*polish (male)*/]],
        k: [[/^(k)+$/, tagset_1.EXP]],
        ...
        m: [[/.[^aeiou]ium$/, tagset_1.SI], [/[^aeiou]ism$/, tagset_1.SI], [/.[^aeiou]ium$/, tagset_1.SI],
            [/^mmm+$/, tagset_1.EXP /*mmmm*/], [/^[hu]m+$/, tagset_1.EXP /*ummm*/], [/^[0-9]+ ?(am|pm)$/, 'Date']],
        n: [[/.[lsrnpb]ian$/, tagset_1.ADJ], [/[^aeiou]ician$/, tagset_1.AC]],
        o: [[/^no+$/, tagset_1.EXP /*noooo*/], [/^(yo)+$/, tagset_1.EXP /*yoyo*/], [/^woo+[pt]?$/, tagset_1.EXP /*woo*/]],
        ...
        v: [[/.[^aeiou][ai][kln]ov$/, tagset_1.LN /*east-europe*/]],
