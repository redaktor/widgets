(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "tslib", "./abbreviations"], factory);
    }
    ...
    ;
    var abbreviations_1 = require("./abbreviations");
    ...
    exports.regexps = {
        ...
        urlTld: new RegExp(_(templateObject_1 || (templateObject_1 = tslib_1.__makeTemplateObject(["^[w./]+.(", ")"], ["^[\\w\\.\\/]+\\.(", ")"])), abbreviations_1.tld)),
        startQuote: /^["'\u201B\u201C\u2033\u201F\u2018]/,
        endQuote: /.["'\u201D\u2036\u2019]([;:,.])?$/,
    ...
    function itIs(s, rName) {
        if (rName === void 0) { rName = 'default'; }
        if (rName === 'default' && (!s || typeof s !== 'string')) {
            return false;
        }
        if (Array.isArray(exports.regexpGroups[rName])) {
            return !!exports.regexpGroups[rName].filter(function (k) { return !!exports.regexps[k] && exports.regexps[k].test(s); }).length;
        }
    ...
    exports.punctuationRegexps = punctuationRegs.map(function (a) { return ({
