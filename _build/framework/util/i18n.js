(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "@dojo/framework/i18n/main"], factory);
    }
    ...
    function getLocaleObj(langs_req, bundle) {
        ...
        var langs = (typeof langs_req.acceptsLanguages === 'function') ?
            langs_req.acceptsLanguages() : (Array.isArray(langs_req) ? langs_req : [langs_req]);
        var i;
        for (i = 0; i < langs.length; i++) {
            var rootLang = langs[i].split('-')[0];
    ...
    function getCachedI18n(locale_req, bundle) {
        var locale = (typeof locale_req.acceptsLanguages === 'function') ?
            getLocaleObj(locale_req, bundle).locale : locale_req;
        var cached = main_1.getCachedMessages(bundle, locale);
        if (!!cached) {
            return Promise.resolve({ messages: cached, locale: locale });
        }
        return main_1.default(bundle, locale).then(function (m) { return ({ messages: m, locale: locale }); });
    }
