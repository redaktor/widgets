(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "tslib", "../../../String/tag/log"], factory);
    }
            ...
            additionalProperties: [
                {
                    ...
                    name: 'provider_email',
                    message: function () {
                        return log_1._(templateObject_1 || (templateObject_1 = tslib_1.__makeTemplateObject(["", "\nmuted", " \"foo@example.com\""], ["", "\\nmuted", " \"foo@example.com\""])), this.msg('qMail'), this.msg('eg'));
                    },
                ...
                },
                {
                    ...
                    name: 'provider_name',
                    message: function () {
                        return log_1._(templateObject_2 || (templateObject_2 = tslib_1.__makeTemplateObject(["", " muted", " ", ""], ["", " muted", " ", ""])), this.msg('qName'), ' < 64 ', this.msg('chars'));
                    },
                    default: 'IndieAuth',
                    validate: function (value) {
                ...
                },
                {
                    ...
                    name: 'provider_host',
                    message: function () {
                        return log_1._(templateObject_3 || (templateObject_3 = tslib_1.__makeTemplateObject(["", "\nmuted", ""], ["", "\\nmuted", ""])), this.msg('qHost'), this.msg('qHostNote'));
                    },
                ...
                },
                {
                    ...
                    choices: function (o) {
                        var _this = this;
                        var host = o.provider_host;
                        var ports = [587, 465, 25];
                        return new Promise(function (resolve, reject) {
                            if (!_this || !_this.scanPort) {
                                return;
                            }
                            Promise.all(ports.map(function (_p) { return _this.scanPort(_p, host); })).then(function (pr) {
                                resolve(pr.map(function (status, i) {
                                    var __p = ports[i].toString();
                                    var msg = __p + ' (seems to be ' + status + ')';
                                    return {
                                        name: status === 'open' ? log_1._(templateObject_4 || (templateObject_4 = tslib_1.__makeTemplateObject(["G{msg}"], ["G{msg}"]))) : log_1._(templateObject_5 || (templateObject_5 = tslib_1.__makeTemplateObject(["R{msg}"], ["R{msg}"]))),
                                        value: __p,
                                        short: 'port ' + __p
                                    };
                                }));
