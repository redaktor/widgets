(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "tslib", "../core/constants", "../lang/isFlattenable", "../lang/range"], factory);
    }
    ...
    function _while(a, fn, i, end, _is, st, L, R) {
        ...
        var countFn = i > end ? (function () { return (--i > (end || 0)); }) : (function () { return (++i < (end || a.length)); });
