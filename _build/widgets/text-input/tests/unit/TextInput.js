(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "tslib", "sinon", "@dojo/framework/widget-core/d", "@dojo/framework/widget-core/meta/Focus", "../../../label/index", "../../index", "../../../theme/text-input.m.css", "../../../common/tests/support/test-helpers"], factory);
    }
    ...
    var expected = function (label, inputOverrides, states, focused) {
        ...
        return d_1.v('div', {
            ...
            d_1.v('div', { classes: css.inputWrapper }, [
                d_1.v('input', tslib_1.__assign({ key: 'input', classes: css.input, id: '', disabled: disabled, 'aria-invalid': invalid ? 'true' : null, maxlength: null, minlength: null, name: undefined, placeholder: undefined, readOnly: readOnly, 'aria-readonly': readOnly ? 'true' : null, required: required, type: 'text', value: undefined, onblur: test_helpers_1.noop, onchange: test_helpers_1.noop, onclick: test_helpers_1.noop, onfocus: test_helpers_1.noop, oninput: test_helpers_1.noop, onkeydown: test_helpers_1.noop, onkeypress: test_helpers_1.noop, onkeyup: test_helpers_1.noop, onmousedown: test_helpers_1.noop, onmouseup: test_helpers_1.noop, ontouchstart: test_helpers_1.noop, ontouchend: test_helpers_1.noop, ontouchcancel: test_helpers_1.noop }, inputOverrides))
            ])
        ]);
    };
