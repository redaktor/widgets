...
Burkhard-Keller : https://github.com/yellowiscool/bktree-javascript/blob/master/bktree.js
...
export default class Search {
  ...
  _format (results: SearchResult[]) {
    const { includeMatches, includeScore, verbose, id, getFn = deepValue } = this.properties;
    const finalOutput = [];
    let transformers = [];
