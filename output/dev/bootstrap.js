var shimFeatures = {"no-bootstrap":true,"intersection-observer":true,"resize-observer":false,"web-animations":false,"build-fetch":false};
...
window.DojoHasEnvironment = { staticFeatures: shimFeatures };(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		define("redaktor_widgets", [], factory);
	else if(typeof exports === 'object')
		exports["redaktor_widgets"] = factory();
	else
		root["redaktor_widgets"] = factory();
})(window, function() {
...
/******/
/******/ 	var jsonpArray = window["dojoWebpackJsonpredaktor_widgets"] = window["dojoWebpackJsonpredaktor_widgets"] || [];
...
module.exports = Promise.all(modules).then(function() {
	return __webpack_require__.e(/*! import() | main */ "main").then(__webpack_require__.bind(null, /*! ./src/main.ts */ "./src/main.ts"));
});
...
if (!global.default['redaktor_widgets']) {
	global.default['redaktor_widgets'] = {};
}
...
var appBase = global.default['redaktor_widgets'].base ? global.default['redaktor_widgets'].base : global.default.__app_base__;

var initialPublicPath = global.default['redaktor_widgets'].publicPath
	? global.default['redaktor_widgets'].publicPath
	: global.default.__public_path__;

var initialPublicOrigin = global.default['redaktor_widgets'].publicOrigin
	? global.default['redaktor_widgets'].publicOrigin
...
__webpack_require__(/*! /Users/sebi/Desktop/MyGithub/widgets/src/main.css */"./src/main.css");
